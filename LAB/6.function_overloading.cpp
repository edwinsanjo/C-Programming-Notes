...
int main()
{
    ...
    do
    {
        ...
        case 3:
            ...
            cin.ignore();
            if (cmax<10){
                if (id==1) addtoCart(ip1,a,cmax);
                else if (id==2) addtoCart(ip2,a,cmax);
                else if (id==3) addtoCart(ip3,a,cmax);
                else if (id==4) addtoCart(ip4,a,cmax);
                else if (id==5) addtoCart(ip5,a,cmax);
